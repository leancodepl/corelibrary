...
namespace ExampleApp.Migrations.Migrations
{
    ...
    [Migration("20230601082825_AddProjects")]
                    ...
                    b.OwnsMany("ExampleApp.Core.Domain.Projects.Assignment", "Assignments", b1 =>
                        {
                            ...
                            b1.HasIndex("ParentProjectId", "Id");

                            SqlServerIndexBuilderExtensions.IsClustered(b1.HasIndex("ParentProjectId", "Id"));
