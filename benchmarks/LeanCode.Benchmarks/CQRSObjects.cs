...
public class MultipleFieldsQueryHandler : IQueryHandler<SampleAppContext, MultipleFieldsQuery, MultipleFieldsDTO>
{
    public static readonly Task<MultipleFieldsDTO> Result = Task.FromResult(
        new MultipleFieldsDTO { F1 = "test field", F2 = 123, }
    );
...
public class MultipleFieldsCommandHandler : ICommandHandler<SampleAppContext, MultipleFieldsCommand>
{
...
{
    public IEnumerable<Role> Roles => new[] { new Role("user", "user"), };
}
