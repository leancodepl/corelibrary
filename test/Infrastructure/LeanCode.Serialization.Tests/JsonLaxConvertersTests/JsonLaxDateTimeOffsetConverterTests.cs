...
public class JsonLaxDateTimeOffsetConverterTests
{
    ...
    public void Correctly_deserialize_and_serialize_DateTimeOffset_with_zero_offset_using_lax_converter(
        string serialized
    )
    {
        Assert.Equal(
            SampleDateTimeOffsetWithZeroOffset,
    ...
    public void Correctly_deserialize_and_serialize_DateTimeOffset_with_non_zero_offset_using_lax_converter(
        string serialized
    )
    {
        Assert.Equal(
            SampleDateTimeOffsetWithNonZeroOffset,
            JsonSerializer.Deserialize<DateTimeOffset>(serialized, LaxSerializerOptions)
        );
    ...
    [Theory]
    [InlineData("\"2021-12-15T12:34:56.115+00:00\"")]
    public void Correctly_serialize_DateTimeOffset_with_zero_offset_and_greater_precision_using_lax_converter(
        string deserialized
    )
    {
        Assert.Equal(
            deserialized,
            JsonSerializer.Serialize(SampleDateTimeOffsetWithZeroOffsetAndGreaterPrecision, LaxSerializerOptions)
        );
    }
    ...
    public void Correctly_deserialize_DateTimeOffset_with_zero_offset_and_greater_precision_using_lax_converter(
        string serialized
    )
    {
        Assert.Equal(
    ...
    public void Correctly_deserialize_DateTimeOffset_with_non_zero_offset_and_greater_precision_using_lax_converter(
        string serialized
    )
    {
        Assert.Equal(
    ...
    public void Correctly_deserialize_DateTimeOffset_with_zero_offset_and_much_greater_precision_using_lax_converter(
        string serialized
    )
    {
        Assert.Equal(
