...
public class LoggerInjectionTests
{
    ...
    public LoggerInjectionTests()
    {
        var hostBuilder = Host.CreateDefaultBuilder()
            .ConfigureDefaultLogging("test", new[] { typeof(LoggerInjectionTests).Assembly });
    ...
    public void Injected_logger_produces_same_output_as_instanced_logger()
    {
        ...
        var injectedLogOutput = GetLogOutput(() => injectedLogger.Information("test"));
        var instancedLogOutput = GetLogOutput(() => instancedLogger.Information("test"));
