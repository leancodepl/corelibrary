...
namespace System
{
    ...
    [DebuggerDisplay("{ToIsoString()}")]
    [JsonConverter(typeof(JsonDateConverter))]
    public readonly struct Date : IEquatable<Date>, IComparable<Date>, IComparable, IFormattable
    {
        ...
        /// recognize that the <see cref="DateTime"/> produced by <c>Date.Today.At(TimeProvider.Now)</c> will have
