...
namespace System
{
    ...
    [DebuggerDisplay("{ToString(System.Globalization.CultureInfo.InvariantCulture)}")]
    [JsonConverter(typeof(JsonTimeConverter))]
    public readonly struct Time : IEquatable<Time>, IComparable<Time>, IComparable, IFormattable
    {
