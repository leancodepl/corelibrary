...
{
    public sealed class QueryFinalizer
        : IPipelineFinalizer<ExecutionContext, IQuery, object>
    {
        private readonly Serilog.ILogger logger = Serilog.Log.ForContext<QueryFinalizer>();
