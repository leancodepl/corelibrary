...
CORELIB_TESTS_CLIENT_ID="${azuread_application.tests.client_id}"
...
CORELIB_TESTS_AZURE_BLOB_STORAGE_SERVICE_URI='${azurerm_storage_account.storage.primary_blob_endpoint}'
CORELIB_TESTS_AZURE_TABLE_STORAGE_SERVICE_URI='${azurerm_storage_account.storage.primary_table_endpoint}'
